<template>
  <div class="balance_part_container">
    <div class="balance_part_header">
      ...
      <div class="balance_info">
        <div class="account">
          <div class="icon_color"><i class="iconfont icon-zhanghuyue"></i></div>
          <div class="info">
            <div>账户余额</div>
            <div>5465461.25P</div>
          </div>
        ...
        <div class="account">
          <div class="icon_colors"><i class="iconfont icon-xinyong"></i></div>
          <div class="info">
            <div>信用余额</div>
            <div>5465461.25P</div>
          </div>
    ...
    <div class="balance_part">
      ...
      <el-table :data="balanceData" stripe style="width: 100%" v-if="isFull==1" :key="isFull">
        ...
        <el-table-column prop="balanceCount" label="收入金额" min-width="175" sortable='custom'></el-table-column>
        <el-table-column prop="unsettledNum" label="入账时间" min-width="165" sortable='custom'></el-table-column>
        ...
        <el-table-column prop="settleNums" label="收入类型" min-width="155"></el-table-column>
      </el-table>
